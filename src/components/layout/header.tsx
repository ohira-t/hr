      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="案件を検索..."
            className="h-9 w-64 rounded-full border border-gray-200 bg-gray-50/50 pl-9 pr-4 text-sm transition-all duration-200 placeholder:text-gray-400 focus:border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-gray-900/5"
          />
        </div>
